...
class Bot {
    ...
    static checkMessage(message) {
        ...
        if (messageText && instructionsRegex.test(messageText)) {
            ...
            message = message.concat("Add a task for a Knight: \"Add Task - <knightname>: TASK\"\n");
            message = message.concat("Remove a task for a Knight: \"Remove Task - <knightname>: TASK#\"\n");
            message = message.concat("A Knight completed a task: \"Task Completed - <knightname>: TASK#\"\n");
            message = message.concat("See all tasks: \"Show Tasks\"\n");
            message = message.concat("See tasks for a bro: \"Show Tasks - <knightname>\"\n");
            message = message.concat("See stats: \"Show Stats\"\n");
            message = message.concat("See stats for a bro: \"Show Stats - <knightname>\"\n");
