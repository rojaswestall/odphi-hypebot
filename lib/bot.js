...
class Bot {
    ...
    static checkMessage(message) {
        ...
        if (messageText && senderName && vistaRegex.test(senderName) && hypeMeRegex.test(messageText)) {
            var vistaPhrases = Array(
                "KAPPAS KAPPAS TILL WE DIE",
                "111119!!!!!",
                "Too Hype Too Hype!",
                "Too Proud Too Proud!",
                ...
                "Frank Ocean is better than SZA : )",
                "lol... brotherhood tree",
                "SOUP Volume 2: The HYPE lyfe of Alex Sanchez");
            return vistaPhrases[Math.floor(Math.random()*vistaPhrases.length)];
        }
